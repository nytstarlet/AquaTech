 ...
 */
    ...
    public class CropBlocks extends BlockCrops implements IGrowable, IPlantable {
        ...
        protected Item getSeeds() {
            ...
            final Item seeds = AquaCrops.seedsMap.get(this);
        ...
        public boolean canUseBonemeal(World worldIn, Random rand, BlockPos pos, IBlockState state) {
            ...
            if (AquaConfig.enableBonemealUse) {
        ...
        protected Item getHarvestedItem() {
            ...
            final Item harvestedItem = AquaCrops.harvestedItemMap.get(this);
        ...
        public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand,
            ...
            if (AquaConfig.rightClickHarvest && isHarvestReady(state)) {
        ...
        public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
            ...
            if (age >= getHarvestReadyAge()) {
                ...
                if ((Math.random() * 100) <= AquaConfig.regularSeedExtraChance) {
