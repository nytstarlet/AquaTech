package com.nytstudios.aquatech.blocks.chests;
 ...
 */
public class AquaChest extends BlockContainer{
    ...
    public AquaChest() {
        super(Material.SAND);
        setUnlocalizedName(Reference.AquaBlocks.AQUACHEST.getUnlocalizedName());
        setRegistryName(Reference.AquaBlocks.AQUACHEST.getRegistryName());
