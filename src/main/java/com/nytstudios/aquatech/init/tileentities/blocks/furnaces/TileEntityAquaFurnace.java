package com.nytstudios.aquatech.init.tileentities.blocks.furnaces;
 ...
 */
public abstract class TileEntityAquaFurnace extends TileEntityLockable implements net.minecraft.util.ITickable, ISidedInventory {
    ...
    public String getName() {
        return this.hasCustomName() ? this.furnaceCustomName : "container.aquafurncae";
    }
    ...
    public void update() {
        ...
        if (!this.worldObj.isRemote) {
            ...
            if (flag != this.isBurning()) {
                flag1 = true;
                AquaFurnaceOn.setState(this.isBurning(), this.worldObj, this.pos);
            }
        }
