 ...
 */
    ...
    public class CropBlocksSpecial extends BlockCrops implements IGrowable, IPlantable {
        ...
        protected Item getSeeds() {
            ...
            final Item seeds = AquaCrops.seedsMapSpecial.get(this);
        ...
        protected Item getHarvestedItem() {
            ...
            final Item harvestedItem = AquaCrops.harvestedItemMapSpecial.get(this);
        ...
        public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
            ...
            if (age >= getHarvestReadyAge()) {
                ...
                if ((Math.random() * 100) <= AquaConfig.specialSeedExtraChance) {
